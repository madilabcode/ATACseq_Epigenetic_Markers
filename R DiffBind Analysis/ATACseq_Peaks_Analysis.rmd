...
write.csv(fgseaRes_CD8_csv, file = "./CD4_GoodvsPoor_Results/GSEA/CD4_Experiment_fgseaRes_CD8_C7gmt_sig.csv", row.names = FALSE)
...
png("./CD4_GoodvsPoor_Results/GSEA/CD4_Experiment_CD8Pathways_top30_GSEA_Plot.png", units="in", width=15, height=15, res=800)
...
# Create a subset where the pathway includes the substring "CD4"
CD8_fgseaRes_CD4 <- subset(CD8_fgseaRes, grepl("CD4", pathway))
CD8_fgseaRes_CD4 <- CD8_fgseaRes_CD4[order(CD8_fgseaRes_CD4$NES,decreasing = TRUE),]
CD8_fgseaRes_CD4_csv <- CD8_fgseaRes_CD4
CD8_fgseaRes_CD4_csv$leadingEdge <- sapply(CD8_fgseaRes_CD4_csv$leadingEdge, paste, collapse = ", ")
...
# Optionally, save these subsets to CSV files
write.csv(CD8_fgseaRes_CD4_csv, file = "./CD8_GoodvsPoor_Results/GSEA/CD8_Experiment_fgseaRes_CD4_C7gmt_sig.csv", row.names = FALSE)
...
topPathwaysUp <- CD8_fgseaRes[NES > 0][order(pval)][1:10,]
topPathwaysDown <- CD8_fgseaRes[NES < 0][order(pval)][1:10,]
topPathways <- rbind(topPathwaysUp, na.omit(topPathwaysDown))
...
png("./CD8_GoodvsPoor_Results/GSEA/CD8_Experiment_topPathWays_GSEA_Plot.png", units="in", width=15, height=15, res=800)
g1
dev.off()
...
#CD4 related pathways
#Removing not important pathways:
CD8_fgseaRes_CD4_filt_NonImportant <- CD8_fgseaRes_CD4[-which(CD8_fgseaRes_CD4$pathway %in% CD8_fgseaRes_CD4[c(4,8,9,10,11,15,18,19),]$pathway),]

CD8_fgseaRes_CD4_top30 = CD8_fgseaRes_CD4_filt_NonImportant[1:30,]
CD8_fgseaRes_CD4_top30$Enrichment = ifelse(CD8_fgseaRes_CD4_top30$NES > 0, "Up-regulated", "Down-regulated")

CD8_fgseaRes_CD4_top30 = rbind(head(CD8_fgseaRes_CD4_top30, n = nrow(subset(CD8_fgseaRes_CD4_top30, NES>0))),
                tail(CD8_fgseaRes_CD4_top30, n = nrow(subset(CD8_fgseaRes_CD4_top30, NES<0)) ))
total_up = sum(CD8_fgseaRes_CD4_top30$Enrichment == "Up-regulated")
total_down = sum(CD8_fgseaRes_CD4_top30$Enrichment == "Down-regulated")
header = paste0("Top ",nrow(CD8_fgseaRes_CD4_top30)," (Total pathways: Up=", total_up,", Down=",  total_down, ")")

colos = setNames(c("firebrick2", "dodgerblue2"),
           c("Up-regulated", "Down-regulated"))

png("./CD8_GoodvsPoor_Results/GSEA/CD8_Experiment_CD4Pathways_top30_GSEA_Plot.png", units="in", width=15, height=15, res=800)
ggplot(CD8_fgseaRes_CD4_top30, aes(reorder(pathway, NES), NES)) +
geom_point( aes(fill = Enrichment, size = size), shape=21) +
scale_fill_manual(values = colos ) +
scale_size_continuous(range = c(2,10)) +
geom_hline(yintercept = 0) +
...
header = paste0("Top ",nrow(CD8_fgseaRes_CD8_top30)," (Total pathways: Up=", total_up,", Down=",  total_down, ")")
