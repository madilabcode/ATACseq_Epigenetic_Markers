...
for Group in CD4_Good CD4_Poor; do
  bam_file="${Group}/Bulk/${Group}_merged.bam"
...
#nohup bash Mac2_PeakCalling_Merged_Bams.sh > Mac2_PeakCalling_Merged_Bams.log 2>&1 &